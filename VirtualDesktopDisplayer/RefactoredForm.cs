...
{
    /// <summary>
    /// Refactored main form with dependency injection and separated concerns.
    /// </summary>
    public partial class RefactoredForm : Form
    {
        // Services
        ...
        {
            var configForm = new TimelyConfigurationForm();
